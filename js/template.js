...
Xwb.Tpl = {
    ...
    Comment : [
        '<li rel="c:{.id},n:{.nick}">',
            ...
            '<div class="comment-content">',
                '<p><a href="{.usrUrl}"[?.sinaV? class="icon-v icon-bg?]>{.nick}</a>：{.text}<span>({.time})</span></p>',
    ...
    MBlogCmt : [
        '<li rel="c:{.id},n:{.nick}">',
            ...
            '</div>',
            '<div class="comment-c">',
                '<p class="c-info"><a href="{.usrUrl}"[?.sinaV? class="icon-v icon-bg?]>{.nick}</a>{.text}({.time}) </p>',
    ...
    PrivateMsgContent : [
        ...
        '<div class="field pad">',
            ...
            '<div class="fr">',
                '<span class="tips fl" id="word">您还可以输入300个字</span>',
