...
<body id="pub">
	<div id="wrapper">    	
    	<div class="wrapper-in">
            ...
            <div class="tab-s1">
                <span><a hideFocus="true" href="<?php echo URL('pub');?>">广场首页</a></span>
                <span class="current"><a hideFocus="true" href="<?php echo URL('pub.look');?>">随便看看</a></span>
    ...
    ?>
                ...
                <div class="main">
                    ...
                    <div class="column-title">
                        <a href="#" class="icon-change icon-bg" rel="e:rl">换一批</a>
                        <h3>随便看看</h3>
                    </div>
                    <div class="feed-list">
    <?php
        TPL::plugin('include/feedlist', array('list' => $list['rst']));
    ?>
                    </div>
					</div>
                </div>
