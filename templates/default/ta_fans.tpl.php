...
<title>关注<?php echo F('escape', $userinfo['screen_name']);?>的人 - Powered By X微博</title>
                    ...
                    <div class="user-list">
                        ...
                        <?php if (empty($list['users'])):?>
                            ...
                            <div class="default-tips">
                                ...
                                <p>已到最后一页</p>
								<?php else:?>
								<p>还没有人关注<?php echo F('escape', $userinfo['screen_name']);?>，快来<a href="#" rel="e:fl,u:<?php echo $userinfo['id'];?>">关注</a><?php echo F('escape', $userinfo['screen_name']);?>吧！ </p>
								<?php endif;?>
                            </div>
                            <!-- end tip -->
                        <?php else:?>
                            ...
                            <li rel="u:<?php echo $item['id'];?>">
                                <div class="list-content">
                                    ...
                                    <div class="content-r">
                                        ...
                                        <?php else:?>
                                            <a href="#" rel="e:fl,t:1" class="addfollow-btn">加关注</a>
                                        <?php endif;?>
                                    </div>
                                    <div class="content-m">
