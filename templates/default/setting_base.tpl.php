...
<script type="text/javascript">
 ...
 var locationData = {"provinces":[{"id":11,"name":"北京","citys":[{"1":"东城区"},{"2":"西城区"},{"3":"崇文区"},{"4":"宣武区"},{"5":"朝阳区"},{"6":"丰台区"},{"7":"石景山区"},{"8":"海淀区"},{"9":"门头沟区"},{"11":"房山区"},{"12":"通州区"},{"13":"顺义区"},{"14":"昌平区"},{"15":"大兴区"},{"16":"怀柔区"},{"17":"平谷区"},{"28":"密云县"},{"29":"延庆县"}]},
...
<script type="text/javascript" src="<?php echo W_BASE_URL;?>js/xwb-all.js"></script>
...
<script type="text/javascript" src="<?php echo W_BASE_URL;?>js/form.js"></script>
</head>
<body id="person">
	<div id="wrapper">
                        ...
                        <div id="infomation" class="form-body">
							...
							<div class="form-con">
                                <div class="form-row">
                                    ...
                                    <input name="nick" vrel="_f|sinan|ne=m:请输入昵称|sz=min:4,max:20,ww,m:大于4个字母，不超过20个字母或10个汉字" warntip="#tip_nick" class="input-a" id="nick" value="<?php echo $U['screen_name'];?>" type="text" />
                                    <div class="check-tips-box tips-wrong hidden" id="tip_nick">
                                        <p><span class="icon-wrong icon-bg"></span><span id="tle"></span></p>
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <select name="city" id="city" preval="<?php echo $U['city'];?>" vrel="_f|ne=m:请选择所在地"  warntip="#tip_city"><option value="">城市/地区</option></select>
                                    <div class="check-tips-box tips-warn hidden" id="tip_city">
                                        <p><span class="icon-warn icon-bg"></span><span id="tle">请选择所在地</span></p>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <textarea name="description" id="description"><?php echo $U['description'];?></textarea>
                                </div>
