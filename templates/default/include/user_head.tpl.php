...
<div class="user-head">
    ...
    <div class="user-head-c" rel="u:<?php echo $userinfo['id'];?>">
        ...
        <div class="user-url"><a href="<?php echo URL('ta', 'id='.$userinfo['id']);?>"><?php echo W_BASE_HTTP.URL('ta', 'id='.$userinfo['id']);?></a></div>
				...
				<?php if (!$blocked):?>
					...
					<?php elseif ($followedBack):?>
						<div class="operated-box">
							...
							<em>|</em>
							<a class="cancel" rel="e:ufl" href="#">取消</a>
						</div>
		...
		<div class="opera-area">
			<span class="opera-area-r">
				<a href="#" rel="e:sd" class="icon-bg icon-post-weibo">我要发微博</a>
			</span>
		</div>
		<?php endif;?>
    </div>
