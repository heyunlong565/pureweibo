...
?>
	...
	?>
		...
		<div class="box-style">
			...
			<div class="forward box-content">
				...
				<span><a href="<?php echo $rtLink;?>" rel="l:fw">原文转发</a>|<a href="<?php echo $rtLink;?>" rel="l:cm">原文评论</a></span>
				</p>
	...
	<?php if ($uid == $user['id']):?><a href="#" rel="e:dl">删除</a>|<?php endif;?><a href="#" rel="e:fw" id="fw">转发</a><?php if ($favorited):?>|<a href="#" rel="e:ufr">取消收藏</a><?php else:?>|<a href="#" rel="e:fr">收藏</a><?php endif;?>|<a href="javascript:;"<?php if (!$disable_comment):?> rel="e:cm"<?php endif;?> id="cm">评论</a>
