...
<div class="user-recommed user-list-search">
	...
	<div class="user-item" rel="u:<?php echo $user['id'];?>">
	    <div class="user-pic"><a href="<?php echo URL('ta', 'id=' . $user['id']); ?>"><img src="<?php echo $user['profile_image_url']; ?>" alt="<?php echo htmlspecialchars($user['screen_name']);?>的头像" /></a></div>
