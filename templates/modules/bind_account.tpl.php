            ...
            <div id="container" class="single">
                <div class="main bind-info">
                    ...
                    <div class="bind-con">
                        <dl>
                            <dt>为什么要进行帐号绑定？</dt>
                            <dd><?php echo V('-:sysConfig/site_name');?>基于新浪微博开发，您需要绑定一个新浪微博帐号，方可使用全部功能。</dd>
                        </dl>
                        <dl>
                            <dt>每次登录都需要绑定吗？</dt>
                            <dd>不需要，您只需要绑定一次，之后就可以直接进入<?php echo V('-:sysConfig/site_name');?>了！</dd>
                        </dl>
                        <dl>
                            <dt>没有新浪微博帐号怎么办？</dt>
                            <dd>点击这里注册，只需1分钟！<br />
                                <a  href="<?php echo W_BASE_HTTP.URL('account.goSinaReg');?>">注册新浪微博帐号</a></dd>
                        </dl>
                    </div>
                </div>
            </div>
