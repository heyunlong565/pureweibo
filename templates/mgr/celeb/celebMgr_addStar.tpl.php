				<form action="<?php echo URL('mgr/celeb_mgr.saveStar');?>" method="post"  name="add-newlink" id="staruserfrm">
                    ...
                    <div class="pop-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-cont">
                                <input name="nickname" id="nickname" class="input-txt" type="text" value="" vrel="_f|sinan|ne=m:请输入昵称|sz=max:20,ww,m:最多10个汉字" warntip="#nicknameTip"/><span id="nicknameTip" class="tips-error hidden"></span>
                            </div>
                        </div>  
                        <?php else: ?>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <label>二级分类</label>
                            <span id="add_cid_2_span"><select name="c_id2" class="input-txt"><option value="0">二级分类</option></select></span>
                        </div>      
                        <div class="form-row">
                            <label>字母索引</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-cont">
                            	<input name="sort" id="sort" class="input-txt" type="text" value="<?php echo isset($info['sort']) ? (int)$info['sort'] : '0'; ?>" vrel="_f|sz=max:4,m:不能大于4位数|ne=m:不能为空" warntip="#sortTip"/><span id="sortTip" class="tips-error hidden"></span>
                            </div>
                        </div>
                        <div class="btn-area">
