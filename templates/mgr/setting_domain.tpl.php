    ...
    <div class="main-cont">
    	...
    	<div class="set-area">
			<div class="form-s1">
				...
				<p class="tips">个性化域名需要服务器支持Rewrite功能，以下提供的规则只适用于<strong style="color:red;">Apache</strong>服务器，并且xweibo安装在<strong style="color:red;">根目录</strong>，规则如下：</p>
				<ul>
				...
				<p class="tips">使用个性化域名后可以使个人微博的域名变得美观有规律。</p>
				<ul>
					<li>1.请登陆sae进入对应应用在代码管理找到readme/config.yaml，把里面的代码复制到apps/APPNAME/1/config.yaml (APPNAME是您的应用名,1代表版本号)。</li>
                ...
                <div class="btn-area"><a href="javascript:$('#RnForm').submit();" class="general-btn btn-s2" name="保存修改"><span>保存修改</span></a></div>
				<?php if (XWB_SERVER_ENV_TYPE != 'sae'):?>
