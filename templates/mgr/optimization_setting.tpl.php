...
<div class="main-cont">
    ...
    <div class="set-area">
        <div class="form-s1">
            ...
            <p class="tips">以下提供的规则只适用于<strong style="color:red;">Apache</strong>服务器，并且xweibo安装在<strong style="color:red;">根目录</strong>，规则如下：</p>
			<ul>
            ...
            <div class="btn-area"><a href="javascript:$('#ReForm').submit();" class="general-btn btn-s2" name="保存修改"><span>保存修改</span></a></div>
        </div>
		<?php if (XWB_SERVER_ENV_TYPE != 'sae'):?>
