			...
			<div class="user-list">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-border">
                    ...
                    <tr>
						...
						<td><a class="cancel-rec" href="javascript:confirmDel('<?php echo URL('mgr/weibo/disableUser.resume','uid='.$row['item'], 'admin.php');?>','确认要解除屏蔽该用户吗?')" >取消屏蔽</a></td>
					</tr>
					<?php }} else {?>
					<tr><td colspan="5">没有搜索到相关数据</td></tr>
					<?php }?>
					</tbody>
				</table>
            </div>
