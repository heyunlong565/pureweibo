                ...
                <ul class="serch-results-shield">
                    ...
                    <p>相关操作：
						<span>
							...
							<a href="javascript:confirmDel('<?php echo URL('mgr/weibo/disableWeibo.resume', 'id=' . $info['id'] . '&type=1', 'admin.php');?>','确认要恢复该微博吗');">恢复该微博</a>
							<?php } else {?>
							<a href="javascript:confirmDel('<?php echo URL('mgr/weibo/disableWeibo.disable', 'id=' . $info['id'], 'admin.php');?>','确认要屏蔽该微博吗?')">屏蔽此微博</a>
							<?php }?>
						</span>
					</p>
                </ul>
