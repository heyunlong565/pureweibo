        ...
        <div class="set-area">
            ...
            <form method="post" id="form1" enctype="multipart/form-data" action="<?php echo URL('mgr/plugins.save', array('id' => 2));?>">
                <div class="form-row">
                    ...
                    <div class="form-cont">
                        <input type="text" name="title" class="input-txt" value="<?php echo F('escape', $cfg['title']);?>">
                    </div>
                </div>
                <div class="form-row">
                    <label for="declare" class="form-field">内容</label>
                    <div class="form-cont">
                        <textarea rows="" cols="" class="input-area area-s5" vrel="sz=max:200,ww,m:不允许超过200字符。" warntip="#textTips" name="text"><?php echo F('escape', $cfg['text']);?></textarea><span id="textTips" class="tips-error hidden"></span>
                        <p class="form-tips">（建议字数不超过74字，超过部分前端将不会显示）</p>
                    </div>
                </div>
                <div class="form-row">
                    <label class="form-field">背景图片</label>
                    <div class="form-cont">
                        <input type="file" onchange="" name="bg" value="" class="btn-file" />
                ...
                <div class="form-row">
                    <label class="form-field">按钮的文字</label>
                    <div class="form-cont">
                        <input type="text" class="input-txt" name="btnTitle" vrel="sz=min:1,max:5,m:最多只能五个字|ne=m:不能为空" warntip="#btnTips" value="<?php echo F('escape', $cfg['btnTitle']);?>"><span class="tips-error hidden" id="btnTips"></span>
                    </div>
                </div>
                <!--div class="focus-set">
                  <p>效果预览：</p>
                ...
                <div class="btn-area"><a href="#" class="general-btn btn-s2" name="ad" id="submitBtn"><span>提交</span></a></div>
            </form>
            </div>
        </div>
    </div>
