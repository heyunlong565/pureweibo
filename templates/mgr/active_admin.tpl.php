		...
		if(err){
			...
			$.post(url, data, function(json){
				...
				if (json.state == '200') {
					...
					if (json.state == '1001') {
						$('#appkeys').html(json.msg).addClass("a-error").show();
						return false;
					}

					if (json.state == '1002') {
						$('#secrets').html(json.msg).addClass("a-error").show();
						return false;
					}
				}
			});
...
<body>
<div id="login-active">
    <div class="login-t"><a href=""></a></div>
    <div class="login-c">
    	<div class="content-border">
        	<h4 class="main-title">激活管理员帐号</h4>
            <form action="" method="post" onsubmit="check();return false;">
            	<div class="active-password">
            		<div class="pwd-t"><span class="pwd-t-icon"></span>管理员密码设置<span>(该密码用于登录Xweibo管理后台)</span></div>
                	<div class="area-one">
            	...
            	<div class="active-contact">
                	<div class="pwd-t"><span class="pwd-t-icon"></span>联系方式<span>(以下资料将用于我们与您联系，为您解决问题或通知您最新产品动态)</span></div>
                	<div class="area-one">
                		<div class="active-two">
