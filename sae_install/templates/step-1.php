			...
			<div class="content-box">
				...
				<div class="ct-mid">
					...
					<div class="form-row">
						...
						<div id="site_name_msg" class="check-tips-box tips-wrong">
							<p><span class="icon-wrong icon-bg"></span><?php echo $_LANG['js_check_input_empty'];?></p>
						</div>
						<div class="tips-correct" id="site_name_tips"><span class="icon-correct icon-bg"></span></div>
					</div>
					<div class="form-row">
						...
						<div id="site_info_msg" class="check-tips-box tips-wrong">
							<p><span class="icon-wrong icon-bg"></span><?php echo $_LANG['js_check_input_empty'];?></p>
						</div>
						<div class="tips-correct" id="site_info_tips"><span class="icon-correct icon-bg"></span></div>
					</div>
					<div class="form-row">
						...
						<div id="app_key_msg" class="check-tips-box tips-wrong">
							<p><span class="icon-wrong icon-bg"></span><?php echo $_LANG['js_check_input_empty'];?></p>
						</div>
						<div class="tips-correct" id="app_key_tips"><span class="icon-correct icon-bg"></span></div>
					...
					<div class="form-row">
						...
						<div id="app_secret_msg" class="check-tips-box tips-wrong">
							<p><span class="icon-wrong icon-bg"></span><?php echo $_LANG['js_check_input_empty'];?></p>
						</div>
						<div class="tips-correct" id="app_secret_tips"><span class="icon-correct icon-bg"></span></div>
						<p><?php echo $_LANG['app_secret_notice'];?></p>
					</div>
					<div class="btn-area">
						<a href="index.php" class="btn-common all-bg mr50"><span><?php echo $_LANG['pre_button'];?></span></a>
...
(function(){
		...
		for(i = 0; i < document.theForm.elements.length; i++) {
			...
			if(window.addEventListener){  //FF  
				...
				document.getElementById(document.theForm.elements[i].name).attachEvent("onblur", function(evt){var evt = window.event?window.event:evt,target=evt.srcElement||evt.target;if (trim(target.value) == ''){document.getElementById(target.name+'_msg').style.display = 'none';document.getElementById(target.name+'_tips').style.display = '';}});
			}
		}
})();
</script>
